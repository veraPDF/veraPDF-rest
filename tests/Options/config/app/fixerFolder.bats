...
setup() {
    ...
    docker cp $BATS_TEST_DIRNAME/fixerFolder/app.xml $DOCKER_CONTAINER:/opt/verapdf-rest/config/app.xml
...
@test "--fixerFolder, Sets a default folder where the repaired files generated by the metadata fixer are written, fixerFolder=$BATS_TEST_TMPDIR" {
