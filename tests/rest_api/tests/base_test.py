...
class BaseClass:
    ...
    PROFILE_GENERAL = (
        ...
        ("4", "PDFA_4", "PDF/A-4 validation profile", 111, ("6.6.1", 2)),
        ("4e", "PDFA_4_E", "PDF/A-4e validation profile", 111, ("6.1.6.2", 1)),
        ("4f", "PDFA_4_F", "PDF/A-4f validation profile", 111, ("6.2.4.2", 3)),
        ("ua1", "PDFUA_1", "PDF/UA-1 validation profile", 106, ("7.18.8", 1)),
        ("ua2", "PDFUA_2", "PDF/UA-2 + Tagged PDF validation profile", 1727, ("5", 5)),
        ("wt1a", "WTPDF_1_0_ACCESSIBILITY", "WTPDF 1.0 Accessibility validation profile", 1723, ("8.4.3", 3)),
        ("wt1r", "WTPDF_1_0_REUSE", "WTPDF 1.0 Reuse validation profile", 1710, ("8.4.5.4", 3)),
    )
