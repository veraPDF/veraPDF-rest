...
class BaseClass:
    ...
    PROFILE_GENERAL = (
        ...
        ("ua1", "PDFUA_1", "PDF/UA-1 validation profile", 105, ("7.18.8", 1)),
        ("ua2", "PDFUA_2", "PDF/UA-2 + Tagged PDF validation profile", 1723, ("5", 5)),
        ("wt1a", "WTPDF_1_0_ACCESSIBILITY", "WTPDF 1.0 Accessibility validation profile", 1727, ("8.4.3", 3)),
        ("wt1r", "WTPDF_1_0_REUSE", "WTPDF 1.0 Reuse validation profile", 1714, ("8.4.5.4", 3)),
    )
