...
class BaseClass:
    ...
    PROFILE_GENERAL = (
        ...
        ("ua2", "PDFUA_2", "PDF/UA-2 + Tagged PDF validation profile", 1689, ("5", 5)),
        ("wt1a", "WTPDF_1_0_ACCESSIBILITY", "WTPDF 1.0 Accessibility validation profile", 1685, ("8.4.3", 3)),
        ("wt1r", "WTPDF_1_0_REUSE", "WTPDF 1.0 Reuse validation profile", 1672, ("8.4.5.4", 3)),
    )
