...
def test_profiles_list_check(get_base_url):
    ...
    for prof_item in profile_list:
        ...
        assert profile_info.creator == BaseClass.CREATOR
    ...
    assert profiles_item_list == BaseClass.PROFILE_NAMES
